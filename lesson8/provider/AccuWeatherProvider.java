...
import ru.geekbrains.lesson8.repository.DatabaseRepository;
import ru.geekbrains.lesson8.repository.DatabaseRepositorySQLiteImpl;
import ru.geekbrains.lesson8.configuration.GlobalSettings;
import ru.geekbrains.lesson8.dto.WeatherResponse;
...
public class AccuWeatherProvider implements WeatherProvider {
    ...
    private static final String API_KEY = GlobalSettings.getInstance().getApiKey();
    ...
    public void getWeather(Periods periods) throws IOException, SQLException {
        ...
        if (periods.equals(Periods.NOW)) {
            ...
            System.out.println("Сейчас в городе " + GlobalSettings.getInstance().getSelectedCity() +
        ...
        if (periods.equals(Periods.FIVE_DAYS)) {
            ...
            for (WeatherResponse weather: weatherResponseList) {
                System.out.println("В городе " + GlobalSettings.getInstance().getSelectedCity() + " на следующую дату " + weather.getDate().substring(0,10) +
                ...
                WeatherData weatherData = new WeatherData(GlobalSettings.getInstance().getSelectedCity(),
    ...
    public String detectCityKey() throws IOException {
        String selectedCity = GlobalSettings.getInstance().getSelectedCity();
